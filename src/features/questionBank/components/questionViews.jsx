    ...
    return (
      <div className="qb-match-list">
        {(question.pairs || []).map((pair, index) => (
          <div key={index} className="qb-match-row">
            <span className="qb-match-left">
              <HtmlContent html={pair.left || ""} />
            </span>
            <span className="qb-match-divider">=</span>
            <span className="qb-match-right">
              <HtmlContent html={pair.right || ""} />
            </span>
          </div>
        ))}
      </div>
